...
// App Service
//*****************************************************************************************************
module appService 'br:vidalabacr2.azurecr.io/bicep/patterns/appservice:v1.0.0' = {
...
// Function App
//*****************************************************************************************************
module functionAppModule 'br:vidalabacr2.azurecr.io/bicep/patterns/functionapp:v1.0.0' = {
...
//*****************************************************************************************************
module storageAccountModule 'br:vidalabacr2.azurecr.io/bicep/patterns/storage-account:v1.0.0' = {
